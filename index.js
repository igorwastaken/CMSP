...
function checkForUpdates() {
    ...
    autoUpdater.on('error', (err) => {
        dialog.showErrorBox('Erro ao atualizar', err == null ? "erro desconhecido" : (err.stack || err).toString());
    });
    ...
    autoUpdater.on('update-downloaded', () => {
        dialog.showMessageBox({
            ...
            message: 'Uma nova versão foi baixada. Deseja reiniciar para aplicar a atualização?',
